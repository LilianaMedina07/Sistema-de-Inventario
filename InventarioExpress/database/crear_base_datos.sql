-- Crear base de datos y tablas para InventarioExpress (SQL Server)
...
-- 4) Insertar usuario admin (contraseña hasheada con SHA2_256)
-- Nota: el campo password almacena el hash en formato hexadecimal
...
BEGIN
    ...
    -- Convertir a hex string para almacenamiento legible
...
-- 5) Insertar 5 productos de ejemplo
